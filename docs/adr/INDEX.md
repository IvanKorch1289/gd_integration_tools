...
Всего ADR-файлов: **189**; уникальных слотов: **184**.

⚠️ Collision-слоты (5): ADR-0109, ADR-0226, ADR-0227, ADR-0228, ADR-0232. Каждая пара — два ADR на один номер; ренейм отложен из-за внешних ссылок (см. R3.0).
