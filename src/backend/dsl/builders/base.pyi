...
class RouteBuilder:
    ...
    def recipient_list(self, recipients: list[str] | Callable[[Exchange[Any]], list[str]], *, parallel: bool = ..., name: Union[str, None] = ...) -> RouteBuilder:
    ...
    def s3_list(self, *, prefix_from: Union[str, None] = ..., result_property: str = ...) -> RouteBuilder:
