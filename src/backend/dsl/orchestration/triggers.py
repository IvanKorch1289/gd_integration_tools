...
class WebhookTrigger:
    ...
    async def start(self) -> None:
        ...
        if app is None:
            try:
                from src.backend.entrypoints.api.app import (  # noqa: F401 — re-export  # type: ignore[import-not-found,import-untyped]  # optional app-импорт (dev_light), ImportError fallback
