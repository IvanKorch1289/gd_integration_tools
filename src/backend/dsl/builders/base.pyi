...
class RouteBuilder:
    ...
    def agent_graph(self, *, graph_type: str, model: str = ..., agents: Union[list[dict[str, Any]], None] = ..., prompt_inline: Union[str, None] = ..., tool_actions: Union[list[str], None] = ..., max_handoffs: int = ..., result_property: str = ..., isolated: bool = ...) -> RouteBuilder:
    ...
    def from_cdc_capture(cls: Any, route_id: str, profile: str, tables: list[str], *, strategy: str = ..., interval: float = ..., timestamp_column: str = ..., batch_size: int = ..., channel: Union[str, None] = ..., **kwargs: Any) -> RouteBuilder:
    ...
    def from_filewatcher(cls: Any, route_id: str, path: str | Path | None = ..., *, paths: str | Path | list[str | Path] | None = ..., recursive: bool = ..., glob_include: Union[list[str], str, None] = ..., glob_exclude: Union[list[str], str, None] = ..., batch_size: Union[int, None] = ..., batch_window: Union[float, None] = ..., **kwargs: Any) -> RouteBuilder:
        """Создаёт маршрут с источником FileWatcher (watchfiles.awatch)."""
        ...

    def from_grpc_stream(cls: Any, route_id: str, target: str, stub_module: str, stub_class: str, method: str, request_module: str, request_class: str, request_kwargs: Union[dict[str, Any], None] = ..., **kwargs: Any) -> RouteBuilder:
    ...
    def from_http(self, url: str, *, expected_status: int = ..., method: str = ..., body_match: Union[str, None] = ..., poll_interval_s: float = ...) -> RouteBuilder:
    ...
    def from_sse(cls: type[_T], route_id: str, url: str, *, headers: Union[dict[str, str], None] = ..., event_type: Union[str, None] = ..., last_event_id: Union[str, None] = ..., heartbeat_timeout_s: float = ..., reconnect_max_retries: Union[int, None] = ..., parse_json: bool = ...) -> _T:
        """SSE consumer: регистрирует маршрут с SSE-источником."""
        ...

    def from_sse_multi(cls: type[_T], route_id: str, urls: list[str], *, merge_strategy: str = ..., headers: Union[dict[str, str], None] = ..., event_type: Union[str, None] = ..., heartbeat_timeout_s: float = ..., reconnect_max_retries: Union[int, None] = ..., parse_json: bool = ...) -> _T:
    ...
    def mask(self, *, patterns: Union[list[str], None] = ..., replacement: str = ...) -> Self:
    ...
    def notebook_execute(self, user_name: str, notebook_path: str, *, timeout_seconds: Union[float, None] = ...) -> RouteBuilder:
        """Выполнить Jupyter notebook через JupyterHub."""
        ...

    def notebook_export(self, user_name: str, notebook_path: str, *, fmt: str = ..., timeout_seconds: Union[float, None] = ...) -> RouteBuilder:
    ...
    def script_python(self, code: str, *, timeout_seconds: float = ..., env: Union[dict[str, str], None] = ..., allowed_languages: Union[list[str], None] = ...) -> RouteBuilder:
        """Выполнить inline Python-код через текущий интерпретатор."""
        ...

    def script_ruby(self, code: str, *, timeout_seconds: float = ..., env: Union[dict[str, str], None] = ..., allowed_languages: Union[list[str], None] = ...) -> RouteBuilder:
        """Выполнить inline Ruby-код (требует ``ruby`` в PATH)."""
        ...

    def script_shell(self, code: str, *, timeout_seconds: float = ..., env: Union[dict[str, str], None] = ..., allowed_languages: Union[list[str], None] = ...) -> RouteBuilder:
    ...
    def ssh_command(self, host: str, command: str, *, username: Union[str, None] = ..., password_from: str = ..., key_file: Union[str, None] = ..., timeout: float = ..., result_property: str = ..., continue_on_error: bool = ...) -> RouteBuilder:
