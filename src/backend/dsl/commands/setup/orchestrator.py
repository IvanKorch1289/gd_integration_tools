...
from src.backend.dsl.commands.setup.registers_integrations import (
    ...
    _register_anomaly_detection,  # S66 W2: orchestrator cross-import
    _register_notebooks_wave_9_1,  # S66 W2: orchestrator cross-import
    _register_rag_vector_db_llm,  # S66 W2: orchestrator cross-import
...
from src.backend.dsl.commands.setup.registers_workflow import (
    ...
    _register_message_replay,  # S66 W2: orchestrator cross-import
    _register_notifications_email_express_webhook_telegram,  # S66 W2: orchestrator cross-import
    _register_scheduled_reports,  # S66 W2: orchestrator cross-import
    _register_web_automation_multi_protocol,  # S66 W2: orchestrator cross-import
