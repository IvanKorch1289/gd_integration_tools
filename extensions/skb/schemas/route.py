"""S168 W17 P2-10: route_schemas для SKB (СКБ-Техно).

S168 W17 P2-10: moved from src/backend/schemas/route_schemas/skb.py
to extensions/skb/schemas/route.py per master prompt v8 P2-10.
SKB is cross-cutting (external system integration) — own extension.
"""
