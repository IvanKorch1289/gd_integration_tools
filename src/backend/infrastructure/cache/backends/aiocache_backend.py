...
def _ensure_aiocache_available() -> None:
    ...
    try:
        import aiocache  # type: ignore[import-not-found]  # noqa: F401
...
class AiocacheMemoryBackend(CacheBackend):
    ...
    def __init__(self, maxsize: int = 1000, default_ttl: int = 3600) -> None:
        ...
        from aiocache import Cache  # type: ignore[import-not-found]  # noqa: WPS433
        from aiocache.backends.memory import (  # type: ignore[import-not-found]
            SimpleMemoryCache,  # noqa: WPS433
        )
