...
class MessagingSourcesMixin:
    ...
    def from_kafka(
        ...
        **kwargs: Any,
        ...
        builder: RouteBuilder = cls(route_id=route_id, source=f"kafka:{topic}")  # type: ignore[call-arg,assignment]
    ...
    def from_rabbit(
        ...
        builder: RouteBuilder = cls(route_id=route_id, source=f"rabbitmq:{queue}")  # type: ignore[call-arg,assignment]
        object.__setattr__(builder, "_source_instance", source_instance)
        return builder
    ...
    def from_mqtt(
        ...
        builder: RouteBuilder = cls(route_id=route_id, source=f"mqtt:{topic}")  # type: ignore[call-arg,assignment]
