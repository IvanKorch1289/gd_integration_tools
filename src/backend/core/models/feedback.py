"""DTO AI Feedback Loop.

Pydantic-документы, описывающие ответ AI-агента, его разметку
оператором и статус перевода в RAG-индекс. Хранилище-агностичны
(in-memory, MongoDB, Postgres) — используются и сервисом, и
infrastructure-репозиторием.
"""
