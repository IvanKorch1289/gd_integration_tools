...
3. Составить точный план (переключись в `planmode` и используй Opus, после составления плана - отправь на согласование. После положительного согласования - переключись на Sonnet)
