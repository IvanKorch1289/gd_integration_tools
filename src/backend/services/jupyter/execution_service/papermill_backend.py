...
class PapermillExecutionBackend:
    ...
    * **No streaming output.** Papermill waits для full execution
    ...
    async def execute_with_params(
        ...
        try:
            import papermill as pm  # type: ignore[import-not-found]  # noqa: F401 — availability probe
            from papermill.exceptions import (  # type: ignore[import-not-found]  # noqa: F401 — availability probe
                PapermillExecutionError as PMError,
            )
        except ImportError as exc:
            from src.backend.services.jupyter.execution_service.errors import (  # noqa: F401 — availability probe
