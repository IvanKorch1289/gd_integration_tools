# ADR-0237: Sprint 165 Closure — Facades + CB + Hot-reload (7 atomic, score 9.9, 0 NEW violations)
...
(`docs/adr/0236-sprint-161-closure.md` + parent plan). Цель — закрыть
критические gap'ы по Rule 1 (Facades), Rule 6 (Stability) и Rule 7
(Hot-reload).
...
- **After S165**: dsl 7 failed (-7), core 5 failed (sibling), services 0 failed
...
6. **StorageFacade consumers** (file processors) — to S165-W8+ Sprint 166.
