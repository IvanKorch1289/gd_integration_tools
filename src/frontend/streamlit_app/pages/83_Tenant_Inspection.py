...
# ─────────────────────────────────────────────────────────────────────────
st.subheader("1. Tenant overview + cache hit-rates")
...
cols_overview[2].metric("Cache hits (1h)", _safe_metric("cache_hits_total"))
cols_overview[3].metric("Cache misses (1h)", _safe_metric("cache_misses_total"))
