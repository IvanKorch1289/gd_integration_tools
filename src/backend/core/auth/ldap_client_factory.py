...
def get_ad_client(
    *, feature_flag_enabled: bool | None = None, connection_factory: Any | None = None,
    ...
    try:
        from src.backend.core.auth.ldap_contract import AdServerConfig  # noqa: F401 — availability probe
        from src.backend.core.di.providers.auth import get_ad_directory_client_provider  # noqa: F401 — availability probe
