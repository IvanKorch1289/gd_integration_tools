...
# P1 CLI decomposition W5 (v4 §10 P1, 2026-09-24): scaffold sub-app
# (5 commands: service/processor/route/codegen-service/codegen-extract)
# переехал в src/backend/cli/scaffold.py. Typer sub-app pattern: register
# через app.add_typer в manage.py для сохранения CLI contract
# ('python manage.py scaffold <subcmd>' по-прежнему работает).
from src.backend.cli.scaffold import scaffold_app
...
# P1 CLI decomposition W8 (v4 §10 P1, 2026-09-24): import-schema sub-app
# (3 commands: openapi/postman/wsdl, ~58 LOC) переехал в
# src/backend/cli/import_schema.py. Typer sub-app pattern consistent
# с W5 (scaffold) + W6 (workflow).
from src.backend.cli.import_schema import import_schema_app
...
# P1 CLI decomposition W6 (v4 §10 P1, 2026-09-24): workflow sub-app
# (4 commands: import/dryrun/version/cancel, ~284 LOC) переехал в
# src/backend/cli/workflow.py. Typer sub-app pattern consistent с W5 (scaffold).
from src.backend.cli.workflow import workflow_app
...
# P1 CLI decomposition W9 (v4 §10 P1, 2026-09-24): plugin sub-app
# (4 commands: hot-swap/new/serve/publish, ~148 LOC) переехал в
# src/backend/cli/plugin.py. Typer sub-app pattern consistent с W5/W6/W8.
from src.backend.cli.plugin import plugin_app
