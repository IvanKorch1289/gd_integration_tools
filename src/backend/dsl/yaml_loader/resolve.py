...
def _resolve_include_extends(
    ...
    if extends_path is not None:
        ...
        resolved_path = _resolve_contained_path(
            ext_str, base_path, _trusted_root or Path()
        )  # type: ignore[arg-type]  # R2.MYPY: _trusted_root: Path|None; runtime fallback
    ...
    if include_paths is not None:
        ...
        for inc_path in include_paths:
            ...
            resolved_inc = _resolve_contained_path(
                inc_str, base_path, _trusted_root or Path()
