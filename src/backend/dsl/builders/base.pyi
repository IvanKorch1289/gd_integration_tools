...
class RouteBuilder:
    ...
    def agent_graph(
        ...
        *,
        graph_type: str,
        model: str = ...,
        agents: Union[list[dict[str, Any]], None] = ...,
        prompt_inline: Union[str, None] = ...,
        tool_actions: Union[list[str], None] = ...,
        max_handoffs: int = ...,
        result_property: str = ...,
        isolated: bool = ...,
    ) -> RouteBuilder:
    ...
    def execute_dml(
        ...
        *,
        ...
        where: Union[dict[str, Any], None] = ...,
        conflict_keys: Union[list[str], None] = ...,
        result_property: str = ...,
    ) -> RouteBuilder:
