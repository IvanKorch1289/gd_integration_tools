"""S66 W3 - lifespan() extracted from lifecycle/__init__.py.

538 LOC function. Per-concern file split.
"""
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        # S64 W3: outbox dispatcher — feature flag-gated cutover.
        # См. ``_register_outbox_dispatcher()`` для деталей.
