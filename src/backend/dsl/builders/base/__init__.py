...
# S3-3 (M2-#21): Protocol-контракты вынесены в _protocols.py — ре-экспорт
# для обратной совместимости (cycle_30/31 тесты импортируют из ``base``).
from src.backend.dsl.builders.base._protocols import (  # noqa: F401
    _RouteAgentProtocol,
    _RouteAIOpsProtocol,
