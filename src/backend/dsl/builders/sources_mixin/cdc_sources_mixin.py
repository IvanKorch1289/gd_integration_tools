...
class CdcSourcesMixin:
    ...
    def from_cdc(
        ...
        **kwargs: Any,
        ...
        builder: RouteBuilder = cls(route_id=route_id, source=f"cdc:{table}")  # type: ignore[call-arg,assignment]  # R2.MYPY: SourcesMixin __init__ via Protocol
    ...
    def from_cdc_registry(
        ...
        builder: RouteBuilder = cls(route_id=route_id, source=f"cdc-registry:{backend}")  # type: ignore[call-arg,assignment]
        object.__setattr__(builder, "_source_instance", source_instance)
        return builder
    ...
    def from_cdc_logical(
        ...
        **kwargs: Any,
        ...
        builder: RouteBuilder = cls(route_id=route_id, source=f"cdc-logical:{table}")  # type: ignore[call-arg,assignment]
        object.__setattr__(builder, "_source_instance", source_instance)
        return builder
    ...
    def from_cdc_capture(
        ...
        **kwargs: Any,
        ...
        """
        builder: RouteBuilder = cls(  # type: ignore[call-arg,assignment]
