...
from src.config.database import db_init
from src.kinds.schemas import OrderKindAddSchema, OrderKindGetSchema
...
class KindCBV:
    ...
    async def delete_kind(self, kind_id: int):
        return await BaseRepository._delete(kind_id=kind_id, session=self.session)
