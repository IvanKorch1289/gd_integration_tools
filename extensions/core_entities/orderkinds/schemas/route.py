"""S168 W15 P2-10: route_schemas для OrderKind.

S168 W15 P2-10: moved from src/backend/schemas/route_schemas/orderkinds.py
to extensions/core_entities/orderkinds/schemas/route.py per master prompt v8 P2-10.
"""
