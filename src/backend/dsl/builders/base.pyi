...
class RouteBuilder:
    ...
    def batch(
        self, size: int = ..., timeout_ms: int = ..., group_by: Union[str, None] = ...
    ) -> "RouteBuilder":
    ...
    def claim_check_in(
        self, store: str = ..., ttl_seconds: int = ...
    ) -> "RouteBuilder":
    ...
    def file_move(
        self, src: Union[str, None] = ..., dst: Union[str, None] = ..., mode: str = ...
    ) -> "RouteBuilder":
    ...
    def render_docx(
        self, template: str, context_from: Union[str, None] = ..., output_to: str = ...
    ) -> "RouteBuilder":
    ...
    def tenant_scope(
        self, header: str = ..., body_path: Union[str, None] = ..., required: bool = ...
    ) -> "RouteBuilder":
