...
def _create_or_defer_sensor_task(coro_factory: Callable[[], Any], *, name: str) -> Any:
        ...
        *,
        ...
        if hasattr(task, "start"):
            get_trigger_registry().register(
                _FileSensorWrapper(
                    task_factory=lambda: task.start(), name=f"sensor:file:{path}"
                )
            )
        else:
            get_trigger_registry().register(
                _FileSensorWrapper(task=task, name=f"sensor:file:{path}")
            )
        return self  # type: ignore
    ...
    def from_sql(
        ...
        *,
        ...
        if hasattr(task, "start"):  # _DeferredTask
            ...
            get_trigger_registry().register(
                _FileSensorWrapper(task=task, name=f"sensor:sql:{id(self)}")
            )
        return self  # type: ignore
    ...
    def from_http(
        ...
        *,
        ...
        if hasattr(task, "start"):  # _DeferredTask
            ...
            get_trigger_registry().register(
                _FileSensorWrapper(task=task, name=f"sensor:http:{url}")
            )
        return self  # type: ignore
    ...
    def from_s3(
        ...
        *,
        ...
        if hasattr(task, "start"):  # _DeferredTask
            ...
            get_trigger_registry().register(
                _FileSensorWrapper(task=task, name=f"sensor:s3:{bucket}")
            )
        return self  # type: ignore
