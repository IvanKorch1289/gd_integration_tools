...
Revision ID: 5d620ded4a5b
Revises: 
Create Date: 2025-01-21 12:32:08.688261
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_files_version_end_transaction_id"),
        "files_version",
        ["end_transaction_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_files_version_object_uuid"),
        "files_version",
        ["object_uuid"],
        unique=False,
    )
    op.create_index(
        op.f("ix_files_version_operation_type"),
        "files_version",
        ["operation_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_files_version_transaction_id"),
        "files_version",
        ["transaction_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            ...
            "id",
            "transaction_id",
            name=op.f("pk_orderfiles_version"),
        ),
    )
    op.create_index(
        op.f("ix_orderfiles_version_end_transaction_id"),
        "orderfiles_version",
        ["end_transaction_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_orderfiles_version_operation_type"),
        "orderfiles_version",
        ["operation_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_orderfiles_version_transaction_id"),
        "orderfiles_version",
        ["transaction_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            "id", "transaction_id", name=op.f("pk_orderkinds_version")
        ),
    )
    op.create_index(
        op.f("ix_orderkinds_version_end_transaction_id"),
        "orderkinds_version",
        ["end_transaction_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_orderkinds_version_operation_type"),
        "orderkinds_version",
        ["operation_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_orderkinds_version_skb_uuid"),
        "orderkinds_version",
        ["skb_uuid"],
        unique=False,
    )
    op.create_index(
        op.f("ix_orderkinds_version_transaction_id"),
        "orderkinds_version",
        ["transaction_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "pledge_cadastral_number", sa.String(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "is_active",
            sa.Boolean(),
        ...
        sa.Column(
            "is_send_request_to_skb_mod",
            sa.Boolean(),
            server_default=sa.text("false"),
            nullable=False,
        ),
        sa.Column(
            "errors_mod", sa.Boolean(), server_default=sa.text("false"), nullable=False
        ),
        sa.Column(
            "object_uuid_mod",
            sa.Boolean(),
    ...
    op.create_table(
        ...
        sa.Column(
            "email_mod", sa.Boolean(), server_default=sa.text("false"), nullable=False
        ),
        sa.Column(
            "password_mod",
            sa.Boolean(),
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_orders_version_end_transaction_id"), table_name="orders_version"
    )
    op.drop_table("orders_version")
    op.drop_index(
        op.f("ix_orderkinds_version_transaction_id"), table_name="orderkinds_version"
    )
    op.drop_index(
        op.f("ix_orderkinds_version_skb_uuid"), table_name="orderkinds_version"
    )
    op.drop_index(
        op.f("ix_orderkinds_version_operation_type"), table_name="orderkinds_version"
    )
    op.drop_index(
        op.f("ix_orderkinds_version_end_transaction_id"),
        table_name="orderkinds_version",
    )
    op.drop_table("orderkinds_version")
    op.drop_index(op.f("ix_orderkinds_skb_uuid"), table_name="orderkinds")
    op.drop_table("orderkinds")
    op.drop_index(
        op.f("ix_orderfiles_version_transaction_id"), table_name="orderfiles_version"
    )
    op.drop_index(
        op.f("ix_orderfiles_version_operation_type"), table_name="orderfiles_version"
    )
    op.drop_index(
        op.f("ix_orderfiles_version_end_transaction_id"),
        table_name="orderfiles_version",
    )
    ...
    op.drop_index(
        op.f("ix_files_version_end_transaction_id"), table_name="files_version"
    )
