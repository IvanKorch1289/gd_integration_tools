...
from src.backend.dsl.engine.processors.control_flow.choice import ChoiceBranch
...
from src.backend.dsl.builders.transport import Self

from src.backend.dsl.engine.processors.plan_execute_processor import ExecutorFn

from src.backend.dsl.engine.processors.plan_execute_processor import PlannerFn

from src.backend.dsl.engine.processors.plan_execute_processor import VerifierFn

from src.backend.dsl.engine.processors.reflection_loop_processor import CriticFn

from src.backend.dsl.engine.processors.reflection_loop_processor import GeneratorFn
...
class RouteBuilder:
    ...
    def agent_branch(self, *, source_property: str, branches: dict[str, list[BaseProcessor]], default: UnionType[list[BaseProcessor], None] = ...) -> RouteBuilder:
        """Verdict-based routing по ``agent_result`` (S27 W1)."""
        ...

    def agent_graph(self, *, graph_type: str, model: str = ..., agents: UnionType[list[dict[str, Any]], None] = ..., prompt_inline: UnionType[str, None] = ..., tool_actions: UnionType[list[str], None] = ..., max_handoffs: int = ..., result_property: str = ..., isolated: bool = ...) -> RouteBuilder:
        """LangGraph execution as DSL step (S28 W4)."""
        ...

    def agent_loop(self, *, processors: list[BaseProcessor], max_iterations: int = ..., stop_condition_property: UnionType[str, None] = ..., budget_cost_usd: UnionType[float, None] = ..., budget_tokens: UnionType[int, None] = ...) -> RouteBuilder:
        """Циклическое выполнение вложенного pipeline (S27 W1)."""
        ...

    def agent_parallel(self, *, agents: list[dict[str, Any]], result_property: str = ..., timeout_s: UnionType[float, None] = ..., continue_on_error: bool = ...) -> RouteBuilder:
        """Параллельный fan-out агентов через :class:`asyncio.TaskGroup` (S27 W1)."""
        ...

    def agent_run(self, *, workflow_id: str, prompt_ref: UnionType[str, None] = ..., prompt_inline: UnionType[str, None] = ..., policy_ref: UnionType[str, None] = ..., context_property: UnionType[str, None] = ..., result_property: str = ..., timeout_s: float = ..., max_retries: int = ...) -> RouteBuilder:
    ...
    def ai_invoke(self, *, workflow_id: str, prompt_ref: UnionType[str, None] = ..., prompt_inline: UnionType[str, None] = ..., policy_ref: UnionType[str, None] = ..., context_property: UnionType[str, None] = ..., result_property: str = ...) -> RouteBuilder:
        """Алиас :meth:`agent_run` — для семантически нагруженных мест"""
        ...

    def ai_memory_recall(self, *, namespace: str, query: UnionType[str, None] = ..., query_property: UnionType[str, None] = ..., k: int = ..., result_property: str = ...) -> RouteBuilder:
        """RAG-style retrieval из :class:`MemoryProtocol` (S27 W3, ADR-NEW-18)."""
        ...

    def ai_memory_store(self, *, namespace: str, key: UnionType[str, None] = ..., key_property: UnionType[str, None] = ..., value_property: str = ..., ttl_s: UnionType[int, None] = ...) -> RouteBuilder:
        """Запись в :class:`MemoryProtocol` (S27 W3, ADR-NEW-18)."""
        ...

    def ai_rpa(self, *, task: str, ui_context: UnionType[dict[str, Any], None] = ..., action_property: str = ..., model: str = ..., temperature: float = ..., to: str = ...) -> RouteBuilder:
        """AI-driven RPA action selection via LLM (S28 W5, wave:s8/k3-rpa-ai-decide)."""
        ...

    def ai_tool_dispatch(self, *, available_tool_ids: list[str], query: UnionType[str, None] = ..., query_property: UnionType[str, None] = ..., result_property: str = ..., model: str = ..., temperature: float = ...) -> RouteBuilder:
    ...
    def audit(self, *, action: UnionType[str, None] = ..., action_from: UnionType[str, None] = ..., actor: str = ..., actor_from: UnionType[str, None] = ..., resource_from: UnionType[str, None] = ..., outcome: str = ..., outcome_from: UnionType[str, None] = ..., metadata_from: UnionType[str, None] = ..., tenant_id_from: UnionType[str, None] = ..., correlation_id_from: UnionType[str, None] = ..., result_property: str = ...) -> RouteBuilder:
        """Записать событие в immutable audit log (Wave 5.1)."""
        ...

    def auth(self, methods: UnionType[list[str], str] = ..., *, result_property: str = ..., required: bool = ...) -> RouteBuilder:
        """Проверяет авторизацию запроса (Wave 8.1)."""
        ...

    def batch(self, *, size: int = ..., timeout_ms: int = ..., group_by: UnionType[str, None] = ...) -> RouteBuilder:
        """Накопление сообщений в окно с flush по N ИЛИ по таймауту."""
        ...

    def batch_delete(self, table: str, ids: UnionType[list[Any], None] = ..., *, key_field: str = ..., profile: str = ...) -> RouteBuilder:
        """Batch DELETE через SQLAlchemy core."""
        ...

    def batch_insert(self, table: str, items: UnionType[list[dict[str, Any]], None] = ..., *, profile: str = ...) -> RouteBuilder:
        """Batch INSERT через SQLAlchemy core."""
        ...

    def batch_update(self, table: str, items: UnionType[list[dict[str, Any]], None] = ..., *, key_field: str = ..., profile: str = ...) -> RouteBuilder:
        """Batch UPDATE через SQLAlchemy core."""
        ...

    def browser_launch(self, *, headless: bool = ...) -> RouteBuilder:
    ...
    def bulkhead(self, name: str, limit: int, processors: list[BaseProcessor], *, wait: bool = ..., timeout: UnionType[float, None] = ...) -> Self:
    ...
    def call_function(self, ref: str, *, payload_from: str = ..., result_property: str = ..., inject: UnionType[list[str], None] = ...) -> RouteBuilder:
        """Вызов Python-функции ``module:fn`` (R-V15-6, V21 security)."""
        ...

    def call_llm(self, provider: UnionType[str, None] = ..., model: UnionType[str, None] = ...) -> RouteBuilder:
    ...
    def cdc_transform(self, *, operations: UnionType[list[str], None] = ..., project: UnionType[list[str], None] = ..., include_old: bool = ..., include_new: bool = ..., timestamp_field: str = ..., drop_unknown: bool = ...) -> RouteBuilder:
        """CDC event normalization + filtering + projection."""
        ...

    def choice(self, when: list[ChoiceBranch] | list[tuple[Callable[[Exchange[Any]], bool], list[BaseProcessor]]], otherwise: UnionType[list[BaseProcessor], None] = ...) -> RouteBuilder:
        """When/Otherwise: ветвление по JMESPath-веткам или предикатам."""
        ...

    def circuit_breaker(self, processors: list[BaseProcessor], *, failure_threshold: int = ..., recovery_timeout: float = ..., fallback_processors: UnionType[list[BaseProcessor], None] = ..., breaker_name: UnionType[str, None] = ...) -> RouteBuilder:
    ...
    def collect(self, *, field: UnionType[str, None] = ..., key_fn: Callable[[Any], Any] | None = ...) -> RouteBuilder:
    ...
    def content_based_router(self, routes: list[tuple[Callable[[Exchange[Any]], bool], str]], *, default_endpoint: UnionType[str, None] = ...) -> RouteBuilder:
        """Content-Based Router EIP: route по predicate."""
        ...

    def content_enrich(self, *, strategy: str = ..., field: str = ..., source: UnionType[str, None] = ..., value: Any = ..., name: UnionType[str, None] = ...) -> RouteBuilder:
    ...
    def cron_schedule(self, name: str, *, cron_expr: str, workflow_name: str, workflow_args: UnionType[dict[str, Any], None] = ..., namespace: str = ..., task_queue: str = ..., result_property: str = ..., timezone: str = ...) -> RouteBuilder:
    ...
    def crud_list(self, entity: str, *, filters_from: UnionType[str, None] = ..., page: UnionType[int, None] = ..., size: UnionType[int, None] = ..., result_property: str = ...) -> RouteBuilder:
    ...
    def delay(self, delay_ms: UnionType[int, None] = ..., *, scheduled_time_fn: Callable[[Exchange[Any]], float] | None = ...) -> RouteBuilder:
        """Delay: задержка на N миллисекунд или до timestamp."""
        ...

    def depends(self, *deps: UnionType[str, tuple[str, str]]) -> Self:
    ...
    def do_try(self, try_processors: list[BaseProcessor], catch_processors: UnionType[list[BaseProcessor], None] = ..., finally_processors: UnionType[list[BaseProcessor], None] = ...) -> RouteBuilder:
        """Try/Catch/Finally: exception handling в pipeline."""
        ...

    def duckdb_query(self, sql: str, *, sources: UnionType[dict[str, str], None] = ..., persistent_path: UnionType[str, None] = ...) -> RouteBuilder:
    ...
    def email_driven(self, mailbox: str = ..., subject_filter: UnionType[str, None] = ..., extract: str = ...) -> RouteBuilder:
    ...
    def entity_list(self, *, entity: str, filters_from: UnionType[str, None] = ..., page: UnionType[int, None] = ..., size: UnionType[int, None] = ..., page_from: UnionType[str, None] = ..., size_from: UnionType[str, None] = ..., result_property: str = ...) -> RouteBuilder:
    ...
    def es_index(self, index: str, *, doc_id_from: UnionType[str, None] = ...) -> RouteBuilder:
    ...
    def evaluate_rules(self, *, rules: list[Any], context_from: UnionType[str, None] = ..., decision_to: str = ..., default_decision: str = ...) -> RouteBuilder:
    ...
    def excel_read(self, *, sheet_name: UnionType[str, None] = ...) -> RouteBuilder:
        """Читать Excel файл в list[dict]."""
        ...

    def execute_dml(self, operation: str, table: str, *, dialect: str = ..., data: UnionType[dict[str, Any], None] = ..., where: UnionType[dict[str, Any], None] = ..., conflict_keys: UnionType[list[str], None] = ..., result_property: str = ...) -> RouteBuilder:
    ...
    def expose_proxy(self, src: str, *, methods: UnionType[list[str], None] = ..., header_map: UnionType[dict[str, Any], None] = ...) -> RouteBuilder:
        """Объявить роут как прокси-вход."""
        ...

    def express_edit(self, sync_id_from: str = ..., *, bot: str = ..., body: UnionType[str, None] = ..., body_from: UnionType[str, None] = ..., bubble: UnionType[list[list[dict[str, Any]]], None] = ..., keyboard: UnionType[list[list[dict[str, Any]]], None] = ..., status: UnionType[str, None] = ...) -> RouteBuilder:
        """Редактировать ранее отправленное Express сообщение."""
        ...

    def express_mention(self, *, mention_type: str = ..., target_from: UnionType[str, None] = ..., mention_id: UnionType[str, None] = ..., name_from: UnionType[str, None] = ..., property_name: str = ...) -> RouteBuilder:
        """Добавить упоминание (user/chat/channel/contact/all) в exchange-property."""
        ...

    def express_reply(self, body_from: UnionType[str, None] = ..., *, bot: str = ..., source_sync_id_from: str = ..., chat_id_from: str = ..., body: UnionType[str, None] = ..., result_property: str = ...) -> RouteBuilder:
        """Ответить на исходное сообщение Express (reply-thread)."""
        ...

    def express_send(self, body: UnionType[str, None] = ..., *, bot: str = ..., chat_id_from: str = ..., body_from: UnionType[str, None] = ..., bubble: UnionType[list[list[dict[str, Any]]], None] = ..., keyboard: UnionType[list[list[dict[str, Any]]], None] = ..., status: str = ..., silent_response: bool = ..., sync: bool = ..., result_property: str = ...) -> RouteBuilder:
        """Отправить сообщение в Express чат через BotX API."""
        ...

    def express_send_file(self, *, bot: str = ..., chat_id_from: str = ..., s3_key_from: UnionType[str, None] = ..., file_data_property: UnionType[str, None] = ..., file_name: UnionType[str, None] = ..., file_name_from: UnionType[str, None] = ..., body: UnionType[str, None] = ..., body_from: UnionType[str, None] = ..., result_property: str = ...) -> RouteBuilder:
    ...
    def extract(self, selector: str, url: UnionType[str, None] = ..., output_property: str = ...) -> RouteBuilder:
        """Извлечение текста по CSS-селектору."""
        ...

    def facade_get_health(self, name: str, *, to: str = ...) -> RouteBuilder:
    ...
    def file_move(self, src: UnionType[str, None] = ..., dst: UnionType[str, None] = ..., *, mode: str = ...) -> RouteBuilder:
        """Копировать или переместить файл."""
        ...

    def fill_form(self, url: str, fields: UnionType[dict, None] = ..., submit: UnionType[str, None] = ...) -> RouteBuilder:
    ...
    def find_all(self, *, predicate: Callable[[Any], bool] | None = ..., condition: UnionType[str, None] = ...) -> RouteBuilder:
    ...
    def fork_join(self, branches: dict[str, list[BaseProcessor]], *, aggregation: str = ..., timeout_seconds: UnionType[float, None] = ...) -> RouteBuilder:
        """Fork-Join pattern: explicit join semantics поверх ``parallel``."""
        ...

    def forward_to(self, dst: str, *, pass_headers: bool = ..., header_map: UnionType[dict[str, Any], None] = ..., rewrite_path: UnionType[str, None] = ..., timeout: float = ...) -> RouteBuilder:
        """Переслать текущее сообщение в backend без трансформаций."""
        ...

    def from_(cls: Any, route_id: str, source: str, *, description: UnionType[str, None] = ...) -> RouteBuilder:
        """Точка входа: создаёт новый RouteBuilder."""
        ...

    def from_base64(self, b64_string: UnionType[str, None] = ...) -> RouteBuilder:
        """Decode base64 string → ``bytes`` (stdlib ``base64``)."""
        ...

    def from_bencode(self, bcode_bytes: UnionType[bytes, None] = ...) -> RouteBuilder:
        """Parse bencoded bytes → Python object (no external deps)."""
        ...

    def from_cdc(cls: Any, route_id: str, table: str, *, dsn: str = ..., slot_name: str = ..., publication_names: UnionType[list[str], None] = ..., plugin: str = ..., **kwargs: Any) -> RouteBuilder:
        """Создаёт маршрут с источником CDC (PostgreSQL logical replication)."""
        ...

    def from_cdc_capture(cls: Any, route_id: str, profile: str, tables: list[str], *, strategy: str = ..., interval: float = ..., timestamp_column: str = ..., batch_size: int = ..., channel: UnionType[str, None] = ..., **kwargs: Any) -> RouteBuilder:
        """Создаёт маршрут с источником CDC Capture."""
        ...

    def from_cdc_logical(cls: Any, route_id: str, table: str, *, dsn: str, mode: str = ..., slot_name: UnionType[str, None] = ..., publication: UnionType[str, None] = ..., plugin: str = ..., **kwargs: Any) -> RouteBuilder:
    ...
    def from_cron(self, cron_expr: str, *, timezone_name: str = ..., payload: UnionType[dict[str, Any], None] = ...) -> RouteBuilder:
        """Camel-style ``from(\"cron:*/5 * * * *\")`` — cron periodic trigger (S168 W10 P1-2)."""
        ...

    def from_csv(self, csv_string: UnionType[str, None] = ...) -> RouteBuilder:
        """Parse CSV → ``list[dict]``."""
        ...

    def from_event_subscribe(cls: Any, route_id: str, channel: str, *, consumer_group: UnionType[str, None] = ..., filter: Callable[[Any], bool] | None = ..., **kwargs: Any) -> RouteBuilder:
        """Создаёт маршрут с источником EventBus (Redis pub/sub)."""
        ...

    def from_eventbus(self, topic_pattern: str, *, ack_mode: str = ..., name: UnionType[str, None] = ...) -> RouteBuilder:
        """Subscribe маршрут на EventBus topic_pattern (V22 NEW)."""
        ...

    def from_excel(self, excel_bytes: UnionType[bytes, None] = ...) -> RouteBuilder:
        """Parse Excel bytes → ``list[dict]`` (openpyxl)."""
        ...

    def from_file(self, path: str, *, pattern: UnionType[str, None] = ..., recursive: bool = ..., poll_interval_s: float = ...) -> RouteBuilder:
        """Camel-style ``from(\"file:directory?pattern=*\")`` — file sensor trigger."""
        ...

    def from_filewatcher(cls: Any, route_id: str, path: str | Path | None = ..., *, paths: str | Path | list[str | Path] | None = ..., recursive: bool = ..., glob_include: UnionType[list[str], str, None] = ..., glob_exclude: UnionType[list[str], str, None] = ..., batch_size: UnionType[int, None] = ..., batch_window: UnionType[float, None] = ..., **kwargs: Any) -> RouteBuilder:
        """Создаёт маршрут с источником FileWatcher (watchfiles.awatch)."""
        ...

    def from_grpc_stream(cls: Any, route_id: str, target: str, stub_module: str, stub_class: str, method: str, request_module: str, request_class: str, request_kwargs: UnionType[dict[str, Any], None] = ..., **kwargs: Any) -> RouteBuilder:
        """GRPC server-streaming source. See GrpcSource in infrastructure.sources.grpc."""
        ...

    def from_html_unescape(self, html_string: UnionType[str, None] = ...) -> RouteBuilder:
        """HTML-unescape string (entities → ``<>&"'`` chars)."""
        ...

    def from_http(self, url: str, *, expected_status: int = ..., method: str = ..., body_match: UnionType[str, None] = ..., poll_interval_s: float = ...) -> RouteBuilder:
        """Camel-style ``from(\"http:url\")`` — HTTP sensor trigger."""
        ...

    def from_imap(cls: Any, route_id: str, host: str, port: int, user: str, password: str, *, folder: str = ..., subject_filter: UnionType[str, None] = ..., from_filter: UnionType[str, None] = ..., **kwargs: Any) -> RouteBuilder:
        """Фабричный метод: маршрут с источником IMAP IDLE (K3 W5)."""
        ...

    def from_ini(self, ini_string: UnionType[str, None] = ...) -> RouteBuilder:
        """Parse INI → ``dict`` (stdlib ``configparser``)."""
        ...

    def from_interval(self, interval_s: float, *, start_immediately: bool = ..., payload: UnionType[dict[str, Any], None] = ...) -> RouteBuilder:
    ...
    def from_jwt(self, jwt_string: UnionType[str, None] = ..., *, secret: str, algorithm: str = ...) -> RouteBuilder:
    ...
    def from_markdown(self, md_string: UnionType[str, None] = ...) -> RouteBuilder:
        """Parse markdown → ``dict`` (extracts ``# heading`` → content)."""
        ...

    def from_mongo(cls: Any, route_id: str, connection_url: str, database: str, collection: str = ..., *, full_document_lookup: bool = ..., pipeline: UnionType[list[dict[str, Any]], None] = ..., description: UnionType[str, None] = ...) -> Self:
    ...
    def from_msgpack(self, msgpack_bytes: UnionType[bytes, None] = ...) -> RouteBuilder:
        """Parse msgpack → ``dict``/``list`` (fallback: ``pickle``)."""
        ...

    def from_nats(cls: Any, route_id: str, subject: str, *, nats_url: str = ..., description: UnionType[str, None] = ...) -> Self:
        """Точка входа: маршрут из NATS core (sub, без JetStream) — S106 W4."""
        ...

    def from_nats_js(cls: Any, route_id: str, subject: str, stream: str, durable: str, *, nats_url: str = ..., description: UnionType[str, None] = ...) -> Self:
        """Точка входа: маршрут из NATS JetStream durable consumer."""
        ...

    def from_parquet(self, parquet_bytes: UnionType[bytes, None] = ...) -> RouteBuilder:
        """Parse parquet → ``list[dict]`` (pyarrow)."""
        ...

    def from_protobuf_like(self, pb_bytes: UnionType[bytes, None] = ...) -> RouteBuilder:
    ...
    def from_registered_source(cls: Any, route_id: str, source_id: str, *, description: UnionType[str, None] = ...) -> RouteBuilder:
        """Точка входа W23: маршрут запитывается от зарегистрированного Source."""
        ...

    def from_s3(self, bucket: str, key: str, *, region: str = ..., endpoint_url: UnionType[str, None] = ..., poll_interval_s: float = ...) -> RouteBuilder:
    ...
    def from_sql(self, dsn: str, query: str, *, predicate: UnionType[str, None] = ..., poll_interval_s: float = ...) -> RouteBuilder:
        """Camel-style ``from(\"sql:...\")`` — SQL sensor trigger."""
        ...

    def from_sse(cls: type[_T], route_id: str, url: str, *, headers: UnionType[dict[str, str], None] = ..., event_type: UnionType[str, None] = ..., last_event_id: UnionType[str, None] = ..., heartbeat_timeout_s: float = ..., reconnect_max_retries: UnionType[int, None] = ..., parse_json: bool = ...) -> _T:
        """SSE consumer: регистрирует маршрут с SSE-источником."""
        ...

    def from_sse_multi(cls: type[_T], route_id: str, urls: list[str], *, merge_strategy: str = ..., headers: UnionType[dict[str, str], None] = ..., event_type: UnionType[str, None] = ..., heartbeat_timeout_s: float = ..., reconnect_max_retries: UnionType[int, None] = ..., parse_json: bool = ...) -> _T:
        """S96 W4: multi-stream SSE consumer — subscribe N URLs параллельно."""
        ...

    def from_telegram(cls: type[_T], route_id: str, bot_token: str, *, secret_token: UnionType[str, None] = ..., allowed_updates: UnionType[tuple[str, Ellipsis], None] = ..., offset: int = ...) -> _T:
        """Telegram Bot webhook: регистрирует маршрут с Telegram-источником."""
        ...

    def from_toml(self, toml_string: UnionType[str, None] = ...) -> RouteBuilder:
        """Parse TOML → ``dict`` (``tomllib`` stdlib 3.11+)."""
        ...

    def from_url_encoded(self, url_string: UnionType[str, None] = ...) -> RouteBuilder:
        """Parse URL-encoded string → ``dict`` (multi-value → ``list``)."""
        ...

    def from_webdav(cls: Any, route_id: str, url: str, *, watch_path: str = ..., poll_interval_seconds: int = ..., file_pattern: str = ..., username: UnionType[str, None] = ..., password: UnionType[str, None] = ..., processed_marker_path: UnionType[str, None] = ..., marker_dedup: bool = ..., description: UnionType[str, None] = ...) -> Self:
    ...
    def from_xml(self, xml_string: UnionType[str, None] = ...) -> RouteBuilder:
        """Parse XML → ``dict`` (через ``xmltodict`` если есть, иначе stdlib)."""
        ...

    def from_yaml(self, yaml_string: UnionType[str, None] = ...) -> RouteBuilder:
        """Parse YAML → ``dict``/``list``."""
        ...

    def geo(self, mode: str, *, address: UnionType[str, None] = ..., point_a: UnionType[tuple[float, float], None] = ..., point_b: UnionType[tuple[float, float], None] = ..., to: str = ...) -> RouteBuilder:
        """Geocoding, reverse geocoding, or distance calculation."""
        ...

    def get_feedback_examples(self, *, query_from: str = ..., agent_id: UnionType[str, None] = ..., positive_k: int = ..., negative_k: int = ..., min_similarity: float = ..., inject_as: str = ...) -> RouteBuilder:
    ...
    def graphql_query(self, endpoint: str, query: str, *, variables: UnionType[dict[str, Any], None] = ..., operation_name: UnionType[str, None] = ..., headers: UnionType[dict[str, str], None] = ..., auth_token: UnionType[str, None] = ..., auth_header: str = ..., timeout: float = ..., result_property: UnionType[str, None] = ...) -> RouteBuilder:
        """GraphQL query/mutation executor."""
        ...

    def group_by(self, *, field: UnionType[str, None] = ..., key_fn: Callable[[Any], Any] | None = ...) -> RouteBuilder:
    ...
    def guardrails(self, *, max_length: int = ..., blocked_patterns: UnionType[list[str], None] = ..., required_fields: UnionType[list[str], None] = ...) -> RouteBuilder:
        """Проверка LLM output на безопасность (длина, blocklist, required fields)."""
        ...

    def guardrails_apply(self, *, stage: str = ..., source_property: UnionType[str, None] = ..., on_block: str = ..., categories: UnionType[list[str], None] = ...) -> RouteBuilder:
    ...
    def hitl_approval(self, hitl_service: Any, *, title: str, description: str = ..., approvers: UnionType[list[str], None] = ..., timeout_seconds: float = ..., payload_path: UnionType[str, None] = ..., request_info_processors: UnionType[list[BaseProcessor], None] = ...) -> RouteBuilder:
    ...
    def http_call(self, url: str, *, method: str = ..., headers: UnionType[dict[str, str], None] = ..., auth_token: UnionType[str, None] = ..., timeout: float = ..., result_property: UnionType[str, None] = ...) -> RouteBuilder:
    ...
    def image_resize(self, *, width: UnionType[int, None] = ..., height: UnionType[int, None] = ..., output_format: str = ...) -> RouteBuilder:
    ...
    def ingest_file(self, *, file_path: UnionType[str, None] = ..., file_path_from: UnionType[str, None] = ..., content_type: UnionType[str, None] = ..., chunk_size: int = ...) -> RouteBuilder:
    ...
    def invoke(self, action: str, *, mode: str = ..., payload_factory: Callable[[Exchange[Any]], dict[str, Any]] | None = ..., reply_channel: UnionType[str, None] = ..., result_property: str = ..., invocation_id_property: str = ..., timeout: UnionType[float, None] = ..., correlation_id: UnionType[str, None] = ...) -> RouteBuilder:
        """Вызывает action через :class:`Invoker` (W22) с заданным режимом."""
        ...

    def invoke_workflow(self, name: str, *, mode: str = ..., args: UnionType[dict[str, Any], None] = ..., namespace: str = ..., task_queue: str = ..., result_property: str = ..., invocation_id_property: str = ..., reply_timeout_seconds: float = ..., version: UnionType[str, None] = ...) -> RouteBuilder:
        """Запуск Workflow (Temporal/LiteTemporal/PgRunner) — R-V15-7 / R-V15-9."""
        ...

    def ip_restriction(self, allowed_ips: UnionType[set[str], list[str], tuple[str, Ellipsis]], *, path_pattern: UnionType[str, None] = ..., enabled: bool = ...) -> Self:
    ...
    def jwt_sign(self, *, secret_key: str, algorithm: str = ..., expires_in_seconds: UnionType[int, None] = ..., output_property: str = ...) -> RouteBuilder:
    ...
    def ldap_query(self, server: str, base_dn: str, filter: str = ..., *, attributes: UnionType[list[str], None] = ..., username: UnionType[str, None] = ..., password: UnionType[str, None] = ..., use_ssl: bool = ..., timeout: float = ..., result_property: str = ...) -> RouteBuilder:
        """LDAP query executor."""
        ...
    ...
    def llm_fallback(self, *, models: UnionType[list[str], None] = ..., fallback_strategy: str = ..., max_retries: int = ..., result_property: str = ...) -> RouteBuilder:
        """LLM call with automatic fallback across models."""
        ...

    def llm_structured(self, *, model: str, output_schema: Any, prompt: str, retry: int = ..., temperature: float = ..., cost_budget_usd: UnionType[float, None] = ..., to: str = ..., name: UnionType[str, None] = ...) -> RouteBuilder:
        """LLM-вызов с гарантированным Pydantic-объектом."""
        ...

    def load_balance(self, targets: list[str], *, strategy: str = ..., weights: UnionType[list[float], None] = ..., sticky_header: UnionType[str, None] = ...) -> RouteBuilder:
    ...
    def loop(self, processors: list[BaseProcessor], *, count: UnionType[int, None] = ..., until: Callable[[Exchange[Any]], bool] | None = ..., max_iterations: int = ...) -> RouteBuilder:
        """Loop — execute sub-processors N times or until condition."""
        ...

    def mask(self, *, patterns: UnionType[list[str], None] = ..., replacement: str = ...) -> Self:
        """Маскирование PII/PCI в body (ИНН/СНИЛС/карта/email/телефон)."""
        ...

    def mask_pii(self, *, targets: list[str], fields: UnionType[list[str], None] = ..., replacement: str = ..., patterns: UnionType[list[str], None] = ...) -> RouteBuilder:
    ...
    def ml_predict(self, model: str, *, input_field: str = ..., output_property: str = ..., model_type: UnionType[str, None] = ..., name: UnionType[str, None] = ...) -> RouteBuilder:
    ...
    def normalize(self, target_schema: UnionType[type, None] = ...) -> RouteBuilder:
        """Normalizer: автоопределение формата (XML/CSV/YAML/JSON) → canonical dict."""
        ...

    def notebook_dsl(self, notebook_path: str, *, parameters: UnionType[dict[str, Any], None] = ..., output_format: UnionType[str, None] = ..., user_name: str = ..., timeout_seconds: UnionType[float, None] = ...) -> RouteBuilder:
        """Выполнить локальный Jupyter notebook с параметрами через JupyterHub."""
        ...

    def notebook_execute(self, user_name: str, notebook_path: str, *, timeout_seconds: UnionType[float, None] = ...) -> RouteBuilder:
        """Выполнить Jupyter notebook через JupyterHub."""
        ...

    def notebook_export(self, user_name: str, notebook_path: str, *, fmt: str = ..., timeout_seconds: UnionType[float, None] = ...) -> RouteBuilder:
        """Экспортировать Jupyter notebook в HTML/PDF/Python."""
        ...

    def notify(self, channel: str = ..., *, template_key: str = ..., recipient: UnionType[str, None] = ..., priority: str = ..., locale: str = ..., context_property: UnionType[str, None] = ..., result_property: str = ...) -> RouteBuilder:
    ...
    def notify_cascade(self, *, adapters: UnionType[list[Any], None] = ..., adapter_names: UnionType[list[str], None] = ..., recipient_path: str = ..., subject: str = ..., body_path: str = ...) -> RouteBuilder:
    ...
    def on_error(self, *, action: UnionType[str, None] = ..., processors: UnionType[list[BaseProcessor], None] = ..., dlq_stream: str = ...) -> RouteBuilder:
        """Глобальный error handler для pipeline — оборачивает ВСЕ накопленные процессоры."""
        ...

    def optimize_prompt(self, *, prompt_name: str = ..., tenant_id: UnionType[str, None] = ..., limit: int = ..., result_property: str = ...) -> RouteBuilder:
    ...
    def paginate(self, *, next_selector: str = ..., item_selector: UnionType[str, None] = ..., max_pages: int = ..., start_url: UnionType[str, None] = ...) -> RouteBuilder:
    ...
    def parse_llm_output(self, schema: UnionType[type, None] = ...) -> RouteBuilder:
        """Парсинг LLM-ответа в Pydantic-модель (с попыткой извлечь JSON)."""
        ...

    def partition(self, *, field: UnionType[str, None] = ..., predicate: Callable[[Any], bool] | None = ...) -> RouteBuilder:
    ...
    def pii_mask(self, *, scope: str, source_property: str = ..., target_property: UnionType[str, None] = ..., language: str = ...) -> RouteBuilder:
        """Reversible PII tokenization через PIITokenizer (S27 W2, ADR-NEW-21)."""
        ...

    def pii_unmask(self, *, source_property: str = ..., target_property: UnionType[str, None] = ..., token_map_property: str = ..., scope: str = ..., strict: bool = ...) -> RouteBuilder:
    ...
    def poll(self, source_action: str, *, payload: UnionType[dict[str, Any], None] = ..., result_property: str = ...) -> Self:
        """Periodically вызывает action, результат → body."""
        ...

    def print_pdf(self, *, format: str = ...) -> RouteBuilder:
    ...
    def process_fn(self, func: ProcessorCallable, *, name: UnionType[str, None] = ...) -> Self:
    ...
    def proxy(self, src: str, dst: str, *, methods: UnionType[list[str], None] = ..., pass_headers: bool = ..., header_map: UnionType[dict[str, Any], None] = ..., rewrite_path: UnionType[str, None] = ..., timeout: float = ...) -> RouteBuilder:
    ...
    def rag_ingest(self, *, collection: str = ..., source_property: UnionType[str, None] = ..., modal: str = ..., output_property: str = ...) -> RouteBuilder:
        """RAG ingest: добавление документа из body/property в vector store (S11 K3 W2)."""
        ...

    def rag_query(self, *, query_field: str = ..., top_k: int = ..., namespace: UnionType[str, None] = ..., strategy: str = ..., max_staleness_hours: UnionType[float, None] = ..., system_prompt: str = ..., output_property: str = ...) -> RouteBuilder:
        """RAG query с выбором стратегии retrieval (S11 K3 W3)."""
        ...

    def rag_search(self, query_field: str = ..., top_k: int = ..., namespace: UnionType[str, None] = ...) -> RouteBuilder:
        """RAG vector search: top-K ближайших документов по семантике."""
        ...

    def read_file(self, path: UnionType[str, None] = ..., *, binary: bool = ...) -> RouteBuilder:
        """Чтение локального файла в body (text или bytes)."""
        ...

    def read_s3(self, bucket: UnionType[str, None] = ..., key: UnionType[str, None] = ...) -> RouteBuilder:
    ...
    def redirect(self, target_url: UnionType[str, None] = ..., *, status_code: int = ..., url_source: UnionType[str, None] = ..., source_key: UnionType[str, None] = ..., allowed_hosts: UnionType[list[str], None] = ...) -> RouteBuilder:
    ...
    def redis_set(self, key: str, value: str, *, ttl_seconds: UnionType[int, None] = ...) -> RouteBuilder:
    ...
    def reflection_loop_workflow(self, *, generator_workflow_id: str, reflector_workflow_id: str, refiner_workflow_id: UnionType[str, None] = ..., max_iterations: int = ..., stop_verdict: str = ..., result_property: str = ..., history_property: UnionType[str, None] = ..., timeout_s: float = ...) -> RouteBuilder:
    ...
    def region_routing(self, primary: str, fallback: UnionType[str, None] = ..., *, health_check_interval: float = ...) -> RouteBuilder:
    ...
    def render_docx(self, *, template: str, context_from: UnionType[str, None] = ..., output_to: str = ...) -> RouteBuilder:
    ...
    def render_xlsx(self, *, template: UnionType[str, None] = ..., context_from: UnionType[str, None] = ..., output_to: str = ..., mode: str = ...) -> RouteBuilder:
        """Рендерит ``.xlsx`` (``replace`` placeholders или ``append_table``)."""
        ...

    def reply(self, reply_channel: UnionType[str, None] = ..., payload: Any = ..., *, correlation_id: UnionType[str, None] = ...) -> RouteBuilder:
    ...
    def request(self, target_channel: str, payload: Any = ..., *, timeout: float = ..., correlation_id: UnionType[str, None] = ..., result_property: str = ...) -> RouteBuilder:
    ...
    def router_specialist(self, *, llm_router: LLMRouterFn, specialists: list[SpecialistAgent], fallback_specialist: UnionType[str, None] = ..., min_confidence: float = ...) -> RouteBuilder:
        """Добавить :class:`RouterSpecialistProcessor` в pipeline."""
        ...

    def routing_slip(self, steps: Callable[[Exchange[Any]], Any] | list[str], *, header: UnionType[str, None] = ..., strict: bool = ..., max_steps: int = ...) -> RouteBuilder:
    ...
    def rpa_extract(self, *, selector: str, attribute: UnionType[str, None] = ...) -> RouteBuilder:
    ...
    def rpa_screenshot(self, *, full_page: bool = ..., path: UnionType[str, None] = ...) -> RouteBuilder:
        """Browser screenshot (Cycle 15 / P4-A)."""
        ...

    def run_scenario(self, steps: UnionType[list[dict], None] = ...) -> RouteBuilder:
    ...
    def saga_lra(self, steps: list[SagaStep], *, workflow_id: UnionType[str, None] = ..., run_id: UnionType[str, None] = ...) -> RouteBuilder:
    ...
    def sampling(self, *, rate: UnionType[int, None] = ..., fraction: UnionType[float, None] = ..., time_window_ms: UnionType[int, None] = ..., max_in_window: UnionType[int, None] = ..., seed: UnionType[int, None] = ...) -> RouteBuilder:
    ...
    def scan_file(self, *, s3_key_from: UnionType[str, None] = ..., data_property: UnionType[str, None] = ..., on_threat: str = ..., result_property: str = ...) -> RouteBuilder:
    ...
    def scrape_url(self, url: UnionType[str, None] = ..., *, selectors: UnionType[dict[str, str], None] = ..., output_property: str = ...) -> RouteBuilder:
        """Извлечение данных с URL через CSS-селекторы (с SSRF-защитой)."""
        ...

    def screenshot(self, url: UnionType[str, None] = ...) -> RouteBuilder:
        """Скриншот страницы как bytes."""
        ...

    def script_node(self, code: str, *, timeout_seconds: float = ..., env: UnionType[dict[str, str], None] = ..., allowed_languages: UnionType[list[str], None] = ...) -> RouteBuilder:
        """Выполнить inline Node.js-код (требует ``node`` в PATH)."""
        ...

    def script_python(self, code: str, *, timeout_seconds: float = ..., env: UnionType[dict[str, str], None] = ..., allowed_languages: UnionType[list[str], None] = ...) -> RouteBuilder:
        """Выполнить inline Python-код через текущий интерпретатор."""
        ...

    def script_ruby(self, code: str, *, timeout_seconds: float = ..., env: UnionType[dict[str, str], None] = ..., allowed_languages: UnionType[list[str], None] = ...) -> RouteBuilder:
        """Выполнить inline Ruby-код (требует ``ruby`` в PATH)."""
        ...

    def script_shell(self, code: str, *, timeout_seconds: float = ..., env: UnionType[dict[str, str], None] = ..., allowed_languages: UnionType[list[str], None] = ...) -> RouteBuilder:
        """Выполнить shell-скрипт через ``/bin/sh`` (whitelist рекомендуется)."""
        ...

    def semantic_route(self, intents: dict[str, str], *, default_route: UnionType[str, None] = ..., query_field: str = ..., threshold: float = ..., namespace: str = ...) -> RouteBuilder:
    ...
    def sftp_get(self, host: str, remote_path: str, *, username: UnionType[str, None] = ..., password_from: str = ..., key_file: UnionType[str, None] = ..., timeout: float = ..., result_property: str = ...) -> RouteBuilder:
        """S104 W1 — GET файла с SFTP-сервера."""
        ...

    def sftp_put(self, host: str, remote_path: str, *, body_from: str = ..., username: UnionType[str, None] = ..., password_from: str = ..., key_file: UnionType[str, None] = ..., timeout: float = ..., result_property: str = ...) -> RouteBuilder:
    ...
    def shell(self, command: str, *, args: UnionType[list[str], None] = ..., allowed_commands: UnionType[list[str], None] = ..., timeout_seconds: float = ...) -> RouteBuilder:
        """Выполнить shell-команду."""
        ...

    def sink_email(self, *, host: str, from_addr: str, port: int = ..., username: UnionType[str, None] = ..., password: UnionType[str, None] = ..., use_tls: bool = ..., start_tls: bool = ..., default_to: UnionType[str, None] = ..., default_subject: str = ..., payload_property: UnionType[str, None] = ..., result_property: str = ...) -> RouteBuilder:
        """Camel-style fluent для SMTP-публикации (Sprint 3 W1 K3)."""
        ...

    def sink_file(self, *, path: str, mode: str = ..., encoding: str = ..., ensure_dir: bool = ..., payload_property: UnionType[str, None] = ..., result_property: str = ...) -> RouteBuilder:
        """Camel-style fluent для записи в local FS (append / write)."""
        ...

    def sink_grpc(self, *, target: str, full_method: str, secure: bool = ..., timeout: float = ..., payload_property: UnionType[str, None] = ..., result_property: str = ...) -> RouteBuilder:
        """Camel-style fluent для gRPC unary-вызова (Sprint 3 W1 K3)."""
        ...

    def sink_http(self, *, url: str, method: str = ..., headers: UnionType[dict[str, str], None] = ..., timeout: float = ..., payload_property: UnionType[str, None] = ..., result_property: str = ...) -> RouteBuilder:
        """Camel-style fluent для REST POST/PUT/PATCH/DELETE через Sink."""
        ...

    def sink_mq(self, *, broker: str, url: str, topic: str, extra: UnionType[dict[str, Any], None] = ..., payload_property: UnionType[str, None] = ..., result_property: str = ...) -> RouteBuilder:
        """Camel-style fluent для публикации в Kafka/RabbitMQ/Redis-Streams/NATS."""
        ...

    def sink_mqtt(self, *, host: str, topic: str, port: UnionType[int, None] = ..., qos: int = ..., retain: bool = ..., username: UnionType[str, None] = ..., password: UnionType[str, None] = ..., payload_property: UnionType[str, None] = ..., result_property: str = ...) -> RouteBuilder:
        """Camel-style fluent для публикации в MQTT-брокер."""
        ...

    def sink_s3(self, *, bucket: str, key: str, content_type: str = ..., payload_property: UnionType[str, None] = ..., result_property: str = ...) -> RouteBuilder:
        """Camel-style fluent для выгрузки payload в S3/MinIO."""
        ...

    def sink_soap(self, *, wsdl_url: str, operation: str, service_name: UnionType[str, None] = ..., port_name: UnionType[str, None] = ..., timeout: float = ..., payload_property: UnionType[str, None] = ..., result_property: str = ...) -> RouteBuilder:
        """Camel-style fluent для SOAP/WSDL-вызова (Sprint 3 W1 K3)."""
        ...

    def sink_webhook(self, *, url: str, event: str, secret: UnionType[str, None] = ..., timeout: float = ..., extra_headers: UnionType[dict[str, str], None] = ..., payload_property: UnionType[str, None] = ..., result_property: str = ...) -> RouteBuilder:
        """Camel-style fluent для outbound webhook с HMAC-подписью."""
        ...

    def sink_ws(self, *, url: str, extra_headers: UnionType[dict[str, str], None] = ..., timeout: float = ..., payload_property: UnionType[str, None] = ..., result_property: str = ...) -> RouteBuilder:
        """Camel-style fluent для outbound WebSocket publish."""
        ...

    def skill_invoke(self, *, skill_id: str, params_property: UnionType[str, None] = ..., result_property: str = ...) -> RouteBuilder:
    ...
    def sort(self, *, key_fn: Callable[[Any], Any] | None = ..., key_field: UnionType[str, None] = ..., reverse: bool = ...) -> RouteBuilder:
    ...
    def sse_source(self, url: str, event_types: UnionType[list[str], None] = ...) -> RouteBuilder:
        """Source-процессор для Server-Sent Events."""
        ...

    def ssh_command(self, host: str, command: str, *, username: UnionType[str, None] = ..., password_from: str = ..., key_file: UnionType[str, None] = ..., timeout: float = ..., result_property: str = ..., continue_on_error: bool = ...) -> RouteBuilder:
        """SSH remote command execution (Sprint 35)."""
        ...

    def ssh_exec(self, host: str, command: str, *, username: UnionType[str, None] = ..., password_from: str = ..., key_file: UnionType[str, None] = ..., timeout: float = ..., result_property: str = ..., continue_on_error: bool = ...) -> RouteBuilder:
    ...
    def switch(self, field: str, cases: dict[str, list[BaseProcessor]], *, default: UnionType[list[BaseProcessor], None] = ...) -> RouteBuilder:
        """n8n Switch — case/match роутинг по значению поля."""
        ...

    def telegram_edit(self, message_id_from: str = ..., *, bot: str = ..., chat_id_from: str = ..., body: UnionType[str, None] = ..., body_from: UnionType[str, None] = ..., parse_mode: str = ..., inline_keyboard: UnionType[list[list[dict[str, Any]]], None] = ...) -> RouteBuilder:
        """Редактировать ранее отправленное Telegram-сообщение."""
        ...

    def telegram_mention(self, *, user_id_from: str, display_name_from: UnionType[str, None] = ..., parse_mode: str = ..., property_name: str = ..., append: bool = ...) -> RouteBuilder:
        """Создать фрагмент-упоминание пользователя для вставки в текст."""
        ...

    def telegram_reply(self, body_from: UnionType[str, None] = ..., *, bot: str = ..., source_message_id_from: str = ..., chat_id_from: str = ..., body: UnionType[str, None] = ..., parse_mode: str = ..., result_property: str = ...) -> RouteBuilder:
        """Ответить на сообщение Telegram (reply_to_message_id)."""
        ...

    def telegram_send(self, body: UnionType[str, None] = ..., *, bot: str = ..., chat_id_from: str = ..., body_from: UnionType[str, None] = ..., parse_mode: str = ..., inline_keyboard: UnionType[list[list[dict[str, Any]]], None] = ..., reply_keyboard: UnionType[list[list[str]], None] = ..., disable_notification: bool = ..., disable_web_page_preview: bool = ..., result_property: str = ...) -> RouteBuilder:
        """Отправить сообщение в Telegram чат через Bot API."""
        ...

    def telegram_send_file(self, *, bot: str = ..., chat_id_from: str = ..., s3_key_from: UnionType[str, None] = ..., file_data_property: UnionType[str, None] = ..., file_name: UnionType[str, None] = ..., file_name_from: UnionType[str, None] = ..., body: UnionType[str, None] = ..., body_from: UnionType[str, None] = ..., parse_mode: str = ..., disable_notification: bool = ..., result_property: str = ...) -> RouteBuilder:
    ...
    def tenant_scope(self, *, header: str = ..., body_path: UnionType[str, None] = ..., required: bool = ...) -> Self:
    ...
    def timeout(self, processors: list[BaseProcessor], *, seconds: float = ..., fallback_processors: UnionType[list[BaseProcessor], None] = ...) -> RouteBuilder:
        """Timeout — wrap sub-processors with a time limit."""
        ...

    def timer(self, *, interval_seconds: UnionType[float, None] = ..., cron: UnionType[str, None] = ..., max_fires: UnionType[int, None] = ...) -> Self:
    ...
    def to_avro_like(self, schema: UnionType[dict[str, Any], None] = ...) -> RouteBuilder:
    ...
    def to_csv(self, *, headers: UnionType[list[str], None] = ...) -> RouteBuilder:
        """Convert ``list[dict]`` → CSV string."""
        ...

    def to_eventbus(self, topic: str, *, payload_ref: str = ..., name: UnionType[str, None] = ...) -> RouteBuilder:
    ...
    def to_json(self, *, indent: UnionType[int, None] = ...) -> RouteBuilder:
        """Serialize ``exchange.body`` → JSON string в ``out_message.body``."""
        ...

    def to_jwt(self, *, secret: str, algorithm: str = ..., claims: UnionType[dict[str, Any], None] = ...) -> RouteBuilder:
    ...
    def to_nats_js(self, subject: str, *, nats_url: str = ..., headers: UnionType[dict[str, str], None] = ..., payload_property: UnionType[str, None] = ..., result_property: str = ...) -> Self:
    ...
    def unique(self, *, field: UnionType[str, None] = ..., key_fn: Callable[[Any], Any] | None = ...) -> RouteBuilder:
    ...
    def validate_response(self, *, schema: UnionType[type, str, None] = ..., on_error: str = ..., source: str = ...) -> RouteBuilder:
    ...
    def variable(self, key: str, *, default: UnionType[str, None] = ..., scope: str = ..., name: UnionType[str, None] = ...) -> RouteBuilder:
        """Inline variable resolution shortcut."""
        ...

    def variable_resolve(self, *, scope: str = ..., fail_on_unresolved: bool = ..., name: UnionType[str, None] = ...) -> RouteBuilder:
    ...
    def web_search(self, engine: str = ..., *, query: UnionType[str, None] = ..., query_source: UnionType[str, None] = ..., max_results: int = ..., to: str = ..., deep_research: bool = ...) -> RouteBuilder:
        """K3 S5 W9 — web-поиск через WebSearchService (Tavily/Perplexity/SearXNG)."""
        ...

    def webdav(self, url: str, *, username: UnionType[str, None] = ..., password: UnionType[str, None] = ..., mode: str = ..., remote_path: str = ..., source: str = ..., to: str = ...) -> RouteBuilder:
    ...
    def webhook_verify(self, *, secret: str, header: str = ..., algorithm: str = ..., prefix: UnionType[str, None] = ..., on_mismatch: str = ...) -> RouteBuilder:
    ...
    def with_auth(self, *, token: UnionType[str, None] = ..., api_key: UnionType[str, None] = ..., mtls_cert: UnionType[str, None] = ...) -> Self:
    ...
    def with_retries(self, max_attempts: int, *, backoff: UnionType[str, float, None] = ...) -> Self:
    ...
    def write_file(self, path: UnionType[str, None] = ..., *, format: str = ...) -> RouteBuilder:
        """Запись body в файл. format: auto|json|csv|text."""
        ...

    def write_s3(self, bucket: UnionType[str, None] = ..., key: UnionType[str, None] = ..., *, content_type: str = ...) -> RouteBuilder:
        """Выгрузка body в S3."""
        ...

    def zip_archive(self, *, action: str = ..., files_from: UnionType[str, None] = ..., archive_to: str = ..., password: UnionType[str, None] = ...) -> RouteBuilder:
