...
from src.backend.dsl.engine.processors.entity.create import EntityCreateProcessor
from src.backend.dsl.engine.processors.entity.delete import EntityDeleteProcessor
from src.backend.dsl.engine.processors.entity.get import EntityGetProcessor
from src.backend.dsl.engine.processors.entity.list import EntityListProcessor
from src.backend.dsl.engine.processors.entity.update import EntityUpdateProcessor
