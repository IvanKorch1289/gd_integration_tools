...
PAGE_METADATA: dict[str, dict[str, str]] = {
    ...
    "15_Оценка_стоимости_Workflow": {
        "title": "Оценка стоимости Workflow",
    ...
    "17_Replay_Воркфлоу": {
        "title": "Replay Воркфлоу",
        "icon": ":material/replay:",
    },
    "18_Версионирование_Воркфлоу": {
        "title": "Версионирование Воркфлоу",
        "icon": ":material/history:",
    },
    "19_Saga_Компенсации": {
        "title": "Saga Компенсации",
        "icon": ":material/undo:",
    },
    "20_AI_Чат": {
        "title": "AI Чат",
    ...
    "31_DSL_Визуальный_редактор": {
        "title": "DSL Визуальный редактор",
        "icon": ":material/draw:",
    },
    "32_DSL_Конструктор": {
        "title": "DSL Конструктор",
        "icon": ":material/build:",
    },
    "33_DSL_Шаблоны": {
        "title": "DSL Шаблоны",
    ...
    "38_Галерея_блюпринтов": {
        "title": "Галерея блюпринтов",
        "icon": ":material/photo_library:",
    },
    "39_Консоль_вызовов": {
        "title": "Консоль вызовов",
    ...
    "73_Просмотр_конфига": {
        "title": "Просмотр конфига",
        "icon": ":material/settings:",
    },
    "75_Мастер_загрузки_RAG": {
        "title": "Мастер загрузки RAG",
    ...
    "77_Каталог_процессоров": {
        "title": "Каталог процессоров",
        "icon": ":material/category:",
    },
    "78_Плавная_деградация": {
        "title": "Плавная деградация",
        "icon": ":material/trending_down:",
    },
    "79_Редактор_профиля_устойчивости": {
        "title": "Редактор профиля устойчивости",
        "icon": ":material/tune:",
    },
    "80_Параллелизм_конвейера": {
        "title": "Параллелизм конвейера",
        "icon": ":material/linear_scale:",
    },
    "81_Адаптивная_RAG_панель": {
        "title": "Адаптивная RAG панель",
        "icon": ":material/auto_awesome:",
    },
    "83_Инспекция_тенанта": {
        "title": "Инспекция тенанта",
        "icon": ":material/fact_check:",
    },
    "85_Массовая_загрузка_RAG": {
        "title": "Массовая загрузка RAG",
        "icon": ":material/cloud_upload:",
    },
    "86_Аудит_использования_DSL": {
        "title": "Аудит использования DSL",
        "icon": ":material/summarize:",
    },
    "88_Тенантные_фича_флаги": {
        "title": "Тенантные фича флаги",
    ...
    "96_Монитор_зависших_сообщений": {
        "title": "Монитор зависших сообщений",
