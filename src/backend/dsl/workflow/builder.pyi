...
from src.backend.dsl.workflow.builder._protocol import WorkflowStep
...
class WorkflowBuilder:
    ...
    def human_approval(self, name: str, *, approvers_group: str, timeout_s: float = ..., output_key: Union[str, None] = ...) -> Self:
