...
class WorkflowClient(BaseAPIClient):
    """Клиент для workflow operations."""
    ...
    def list_workflows(
        ...
        *,
        ...
        try:
            result = self.get("/api/v1/admin/workflows", params=params)
    ...
    def get_workflow(self, instance_id: str) -> dict[str, Any] | None:
        ...
        try:
            return self.get(f"/api/v1/admin/workflows/{instance_id}")
        except Exception:  # noqa: BLE001
            return None
    ...
    def retry_workflow(self, instance_id: str) -> bool:
        ...
        try:
            self.post(f"/api/v1/admin/workflows/{instance_id}/retry")
            return True
        except Exception:  # noqa: BLE001
            return False
    ...
    def resume_workflow(self, instance_id: str) -> bool:
        ...
        try:
            self.post(f"/api/v1/admin/workflows/{instance_id}/resume")
            return True
        except Exception:  # noqa: BLE001
            return False
    ...
    def list_step_logs(
        ...
        try:
            result = self.get("/api/v1/admin/workflow/step-logs", params=params)
            return result if isinstance(result, list) else []
        except Exception:  # noqa: BLE001
            return []
    ...
    def get_step_detail(self, workflow_id: str) -> dict[str, Any]:
        ...
        try:
            result = self.get(f"/api/v1/admin/workflow/step-logs/{workflow_id}")
