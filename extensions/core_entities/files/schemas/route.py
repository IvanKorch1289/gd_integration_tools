"""S168 W15 P2-10: route_schemas для File.

S168 W15 P2-10: moved from src/backend/schemas/route_schemas/files.py
to extensions/core_entities/files/schemas/route.py per master prompt v8 P2-10.
"""
