"""S168 W15 P2-10: route_schemas для User.

S168 W15 P2-10: moved from src/backend/schemas/route_schemas/users.py
to extensions/core_entities/users/schemas/route.py per master prompt v8 P2-10.
"""
