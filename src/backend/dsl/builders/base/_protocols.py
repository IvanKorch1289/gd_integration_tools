"""Protocol-контракты RouteBuilder (S3-3 / M2-#21 сплит, из base/__init__).
...
S3-3 (ledger): вынесены из ``__init__.py`` (1422 LOC god-module) —
протоколы ~1080 LOC чистой декларации без логики. ``__init__`` ре-экспортирует
все имена (back-compat: cycle_31 тесты импортируют их из ``base``).
"""
