...
class GeoIpProcessor(BaseProcessor):
    ...
    def __init__(self, *, ip_field: str='client_ip', ip_header: str | None=None, output_property: str='geo', name: str | None=None) -> None:
    ...
    async def process(self, exchange: Exchange[Any], context: ExecutionContext) -> None:
        ...
        try:
            ...
            exchange.set_property(self._output, {'ip': ip, 'country': record.country.iso_code, 'country_name': record.country.name, 'city': record.city.name, 'latitude': float(record.location.latitude) if record.location.latitude else None, 'longitude': float(record.location.longitude) if record.location.longitude else None, 'timezone': record.location.time_zone})
...
class JwtSignProcessor(BaseProcessor):
    ...
    def __init__(self, *, secret_key: str, algorithm: str='HS256', expires_in_seconds: int | None=3600, output_property: str='jwt', name: str | None=None) -> None:
...
class JwtVerifyProcessor(BaseProcessor):
    ...
    def __init__(self, *, secret_key: str, algorithm: str='HS256', header: str='Authorization', output_property: str='jwt_claims', name: str | None=None) -> None:
...
class CompressProcessor(BaseProcessor):
    ...
    def __init__(self, *, algorithm: str='gzip', level: int=6, name: str | None=None) -> None:
...
class WebhookSignProcessor(BaseProcessor):
    ...
    def __init__(self, *, secret: str, header: str='X-Webhook-Signature', algorithm: str='sha256', name: str | None=None) -> None:
...
class WebhookSignVerifyProcessor(BaseProcessor):
    ...
    def __init__(self, *, secret: str, header: str='X-Webhook-Signature', algorithm: str='sha256', prefix: str='', on_invalid: str='fail', name: str | None=None) -> None:
...
class DeadlineProcessor(BaseProcessor):
    ...
    def __init__(self, *, timeout_seconds: float=30.0, fail_on_exceed: bool=True, name: str | None=None) -> None:
