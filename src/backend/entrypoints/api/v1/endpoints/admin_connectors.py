...
_CONNECTORS_GUARD = Depends(require_admin((AdminRole.OPERATOR, AdminRole.SUPER_ADMIN)))
router = APIRouter(tags=["Admin · Infrastructure"], dependencies=[_CONNECTORS_GUARD])
