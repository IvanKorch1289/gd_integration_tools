...
def get_v1_routers() -> APIRouter:
    ...
    api_router_v1.include_router(admin_actions_router, tags=["Admin · Actions"])
    api_router_v1.include_router(admin_certs_router, tags=["Admin · Certificates"])
    api_router_v1.include_router(admin_feedback_router, tags=["Admin · Feedback"])
    ...
    api_router_v1.include_router(processors_catalog_router, tags=["DSL Catalog"])
    ...
    api_router_v1.include_router(asyncapi_router, tags=["AsyncAPI"])
    ...
    # проде — закрываем gap.
    api_router_v1.include_router(admin_rag_router, tags=["Admin · RAG"])
    api_router_v1.include_router(admin_parallelism_router, tags=["Admin · Parallelism"])
    api_router_v1.include_router(
