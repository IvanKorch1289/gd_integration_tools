"""ORM-модель Order (S168 W14 P2-10).

S168 W14 P2-10: actual Order SQLAlchemy model moved from
src/backend/core/domain/models/orders.py to this location per
master prompt v8 P2-10.

Раньше это был re-export shim; теперь это canonical location.
Backward-compat re-export остаётся в src/backend/core/domain/models/orders.py.
"""
