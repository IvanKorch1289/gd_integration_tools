...
Всего ADR-файлов: **187**; уникальных слотов: **184**.

⚠️ Collision-слоты (3): ADR-0109, ADR-0226, ADR-0227. Каждая пара — два ADR на один номер; ренейм отложен из-за внешних ссылок (см. R3.0).
