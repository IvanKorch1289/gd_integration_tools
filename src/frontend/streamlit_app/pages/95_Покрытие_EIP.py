...
EIP_PATTERN_MAP: dict[str, dict[str, Any]] = {
    "1. Aggregator": {
        ...
        "class_path": "src.backend.dsl.engine.processors.eip."
    ...
    "3. Content-Based Router": {
        ...
        "class_path": "src.backend.dsl.engine.processors.eip.filter_router_sampling."
        "ContentBasedRouter",
        "status": "canonical",
        "sprint": "pre-V22",
    },
    ...
    "7. Idempotent Receiver": {
        ...
        "class_path": "src.backend.dsl.engine.processors.eip.idempotency."
    ...
    "9. Transactional Client": {
        ...
        "class_path": "src.backend.dsl.engine.processors.eip.transactional."
